...
- 구체적 행동 묘사: "~했습니다", "~하는 모습을 보였어요" 등 관찰 가능한 사실 중심
- 발달적 의미 강조: 단순 행동 나열이 아닌, 그 행동이 보여주는 성장과 발달의 의미를 보육과정과 연결하여 설명
  예) "나뭇가지를 모으는 과정에서 자연과의 교감을 경험하며, 창의적 탐구심이 자라나는 모습을 보여주었어요"
- 개별성 존중: "${childName}"의 고유한 특성과 강점에 초점
- 긍정적 시각: 도전적 행동도 성장의 과정으로 긍정적 재해석
- 부모 공감: 부모가 아이의 하루를 생생히 그릴 수 있도록 구체적 묘사
- 보육과정 연결: 활동이 어떤 교육적 의미를 갖는지 자연스럽게 설명
  예) "손끝의 섬세한 움직임과 집중력이 발달하는 소중한 시간이었습니다"

**작성 예시 (참고):**
"오늘 ㅇㅇ이는 산책길에서 떨어진 나뭇가지를 주워 나무 꼬치놀이를 했어요 🍂

작은 가지들을 하나씩 모으며 "선생님, 이것 좀 보세요!" 하고 신나게 달려오던 모습이 정말 사랑스러웠답니다. ㅇㅇ이는 주운 나뭇가지로 땅바닥에 그림을 그리기도 하고, 친구들과 함께 "나무 요리"를 만드는 상상놀이도 했어요 👏

자연물을 활용한 창의적 놀이를 통해 ㅇㅇ이는 탐구심과 상상력을 마음껏 펼쳤고, 자연과의 교감 속에서 감각을 깨우는 소중한 경험을 했습니다 🌱✨"
...
- 길이: ${styleGuide}
- 구조:
  1. 오늘 있었던 구체적인 행동 묘사 (관찰 가능한 사실 중심)
  2. 그 행동이 가진 발달적 의미 설명 (보육과정과 연결하여 전문적으로)
  3. 부모님께 전하고 싶은 따뜻한 메시지
- 이모지: 적극적으로 사용 (🍂🌱😊💕👏✨🎨 등, 내용과 어울리게 4-6개)
- 호칭: "${childName}이"로 표현 (예: "민준이", "ㅇㅇ이")
- 문체: 부드럽고 감성적이며, 구체적 상황 묘사를 통해 부모가 현장에 있는 듯한 느낌을 줄 것
- 발달적 의미: 단순히 "잘했어요"가 아니라, "~를 통해 ~한 발달을 보여주었습니다" 형태로 전문성 있게 설명
- 주의사항:
