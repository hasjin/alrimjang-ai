  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 via-yellow-50 to-pink-50">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <div className="inline-block bg-green-100 text-green-700 px-5 py-2 rounded-full text-sm font-semibold mb-4">
              🔐 SECURITY
            </div>
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              <span className="text-green-600">관리자도 볼 수 없는</span> 강력한 보안
            </h2>
            <p className="text-xl text-gray-600">
              오직 선생님만 볼 수 있는 안전한 문서 보관
            </p>
          </div>

          <div className="bg-white rounded-3xl shadow-2xl p-10 border-2 border-green-200 mb-8">
            <div className="text-center mb-10">
              <span className="text-6xl mb-4 block">🛡️</span>
              <h3 className="text-3xl font-bold text-gray-800 mb-4">AES-256-GCM 암호화</h3>
              <p className="text-lg text-gray-600 leading-relaxed">
                은행권에서 사용하는 최고 수준의 암호화 기술로 문서를 보호합니다
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-gradient-to-br from-blue-50 to-cyan-100 rounded-2xl p-6 border-2 border-blue-300">
                <div className="text-4xl mb-4 text-center">🔑</div>
                <h4 className="text-xl font-bold text-gray-900 mb-3 text-center">사용자별 암호화 키</h4>
                <p className="text-gray-700 leading-relaxed text-center">
                  선생님마다 고유한 암호화 키가 생성되어<br />
                  본인만 문서를 열람할 수 있습니다
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-6 border-2 border-green-300">
                <div className="text-4xl mb-4 text-center">👨‍💼</div>
                <h4 className="text-xl font-bold text-gray-900 mb-3 text-center">관리자도 못 봅니다</h4>
                <p className="text-gray-700 leading-relaxed text-center">
                  관리자를 포함한 누구도<br />
                  선생님의 문서를 복호화할 수 없습니다
                </p>
              </div>

              <div className="bg-gradient-to-br from-purple-50 to-violet-100 rounded-2xl p-6 border-2 border-purple-300">
                <div className="text-4xl mb-4 text-center">🇰🇷</div>
                <h4 className="text-xl font-bold text-gray-900 mb-3 text-center">개인정보보호법 준수</h4>
                <p className="text-gray-700 leading-relaxed text-center">
                  개인정보보호법에 따른<br />
                  암호화 조치를 완벽히 준수합니다
                </p>
            ...
            <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-2xl p-8 border-2 border-green-300">
              <h4 className="text-2xl font-bold text-gray-900 mb-6 text-center">🔒 암호화 프로세스</h4>
              <div className="grid md:grid-cols-4 gap-4">
                <div className="text-center">
                  <div className="bg-white rounded-xl p-4 mb-3 border-2 border-green-300">
                    <span className="text-3xl">✍️</span>
                  </div>
                  <p className="text-sm font-bold text-gray-900 mb-1">1. 문서 생성</p>
                  <p className="text-xs text-gray-600">알림장 작성</p>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-xl p-4 mb-3 border-2 border-green-300">
                    <span className="text-3xl">🔐</span>
                  </div>
                  <p className="text-sm font-bold text-gray-900 mb-1">2. 자동 암호화</p>
                  <p className="text-xs text-gray-600">사용자 키로 암호화</p>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-xl p-4 mb-3 border-2 border-green-300">
                    <span className="text-3xl">💾</span>
                  </div>
                  <p className="text-sm font-bold text-gray-900 mb-1">3. 안전 저장</p>
                  <p className="text-xs text-gray-600">암호화된 상태로 보관</p>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-xl p-4 mb-3 border-2 border-green-300">
                    <span className="text-3xl">👁️</span>
                  </div>
                  <p className="text-sm font-bold text-gray-900 mb-1">4. 본인만 열람</p>
                  <p className="text-xs text-gray-600">로그인 시 자동 복호화</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 border-2 border-amber-300">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h4 className="text-xl font-bold text-gray-900 mb-3">개인정보 보호 안내</h4>
                <p className="text-base text-gray-800 leading-relaxed mb-3 font-medium">
                  알도AI는 생성된 문서를 <strong className="text-orange-600">AES-256-GCM 암호화</strong>로 안전하게 저장합니다.
                  선생님께서 로그인하시면 자동으로 복호화되어 보이며, <strong className="text-orange-600">관리자를 포함한 타인은 절대 열람할 수 없습니다.</strong>
                </p>
                <p className="text-sm text-gray-700 leading-relaxed">
                  💡 <strong>보안 팁:</strong> 민감한 개인정보(주민등록번호 등)는 입력하지 않는 것을 권장하며,
                  문서 내보내기 후에는 필요시 직접 삭제하실 수 있습니다.
                </p>
              </div>
            </div>
          </div>
